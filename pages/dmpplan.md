...
Our digital collection thematic research topic focusses on protest movements on US college campuses during the Vietnam war. This collection spans from 1965 to 1972 and depicts many aspects of protests during this very controversial time in American history. Containing images of student protests, speakers, signs, and posters, this collection provides insight into the role of young people in nationwide events and what they did to get their voices heard.

**Data Curation Methodology**

Our data collection primarily came from GLAMS, including the oregon digital repository, UCLA Library Digital Collections, San Jose State University, Special Collections and Archives, and the University of British Columbia Library. In order to collected at least 20 objects, all four of us each collected a minimum of 5 objects to catalog into our collection, all working out of different GLAMS. We first dealt with catalogging data on a Google Sheet, which we then cleaned and uploaded to collection builder.
